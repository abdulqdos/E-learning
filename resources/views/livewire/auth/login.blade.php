                    ...
                    <div class="grid gap-y-4">
                        ...
                        <div>
                            <div class="flex justify-between items-center">
                                ...
                                <a class="inline-flex items-center gap-x-1 text-sm text-gold decoration-2 hover:underline focus:outline-none focus:underline font-medium" href="#">نسيت كلمة المرور؟</a>
                            </div>
